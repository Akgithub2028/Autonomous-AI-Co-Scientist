...
# Set spawn start method globally to avoid fork deadlocks
try:
...
def get_llm_options():
    ...
    return {
        "Default Fast Model (Groq)": gateway.get_groq_llm(),
        "Default Reasoning Model (Gemini)": gateway.get_gemini_llm(),
    }
