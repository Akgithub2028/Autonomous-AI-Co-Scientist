...
from coscientist.cache import global_cache
from coscientist.model_gateway import safe_invoke
...
class EloTournament:
    ...
    def _determine_winner(
        ...
        # Use tournament prompt for both to save tokens (simulated debate is too expensive)
        ...
        if "1" in winner_str and "2" not in winner_str:
            ...
            # If confusing, default to 1 to keep things moving
            winner = 1
    ...
    def run_round_robin_stage(self, llm: BaseChatModel):
        ...
        # Get all possible pairs that haven't played this stage
        ...
        # Limit to max 8 matches per round to save tokens
            ...
            for i in range(num_contenders // 2):
                ...
                if previous_outcome is None:
                    ...
                    winner, debate = self._determine_winner(
                        hypo1, hypo2, "tournament", llm  # replaced simulated_debate
                    )
