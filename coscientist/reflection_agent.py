...
from coscientist.common import load_prompt, truncate_text
from coscientist.custom_types import ParsedHypothesis, ReviewedHypothesis
from coscientist.search import research_assumption
...
def _sequential_assumption_research_node(
    ...
    for assumption, sub_assumptions in assumptions_to_research:
        ...
        result = asyncio.run(research_assumption(assumption, sub_assumptions))
